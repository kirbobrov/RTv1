...
{
    rt->ray.dir.x = ((2 * ((x + 0.5) * rt->cam.invwidth) - 1) * rt->cam.angle * rt->cam.aspectratio) + rt->cam.horizontal;
    rt->ray.dir.y = ((1 - 2 * ((y + 0.5) * rt->cam.invheight)) * rt->cam.angle) + rt->cam.vertical;
    rt->ray.dir.z = 1;
